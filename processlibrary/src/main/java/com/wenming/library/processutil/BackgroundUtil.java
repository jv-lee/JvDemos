...
import com.wenming.library.processutil.models.GoogleProcess;
...
public class BackgroundUtil {
    ...
    /**
     * 原生Rom 5.0 - 6.0 使用该方法获取栈顶包名
     *
     * @return
     */
    public static String getGoogleCoreInfo() {
        return GoogleProcess.getForegroundApp();
    }

    /**
     * 所有Rom 5.0以下使用该方法获取 栈顶包名
     *
     * @param context
     * @return
     */
