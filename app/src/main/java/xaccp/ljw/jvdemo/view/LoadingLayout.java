...
import xaccp.ljw.jvdemo.utils.DensityUtils;
import xaccp.ljw.jvdemo.utils.GetUtils;
...
public class LoadingLayout extends FrameLayout {
    ...
    private void build() {
        ...
        errorText = GetUtils.findViewById(errorPage, R.id.error_text);
        emptyText = GetUtils.findViewById(emptyPage, R.id.empty_text);
        networkText = GetUtils.findViewById(networkPage, R.id.no_network_text);

        errorImg = GetUtils.findViewById(errorPage, R.id.error_img);
        emptyImg = GetUtils.findViewById(emptyPage, R.id.empty_img);
        networkImg = GetUtils.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = GetUtils.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = GetUtils.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(GetUtils.getColor(mContext, tipTextColor));
        emptyText.setTextColor(GetUtils.getColor(mContext, tipTextColor));
        networkText.setTextColor(GetUtils.getColor(mContext, tipTextColor));
        ...
        errorReloadBtn.setTextColor(GetUtils.getColor(mContext, buttonTextColor));
        networkReloadBtn.setTextColor(GetUtils.getColor(mContext, buttonTextColor));

        if (buttonHeight != -1) {

            errorReloadBtn.setHeight(DensityUtils.dp2px(mContext, buttonHeight));
            networkReloadBtn.setHeight(DensityUtils.dp2px(mContext, buttonHeight));
        }
        if (buttonWidth != -1) {

            errorReloadBtn.setWidth(DensityUtils.dp2px(mContext, buttonWidth));
            networkReloadBtn.setWidth(DensityUtils.dp2px(mContext, buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(GetUtils.getColor(mContext, id));
        networkReloadBtn.setTextColor(GetUtils.getColor(mContext, id));
        return this;
    }
